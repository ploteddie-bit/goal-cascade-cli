# Traçabilité G.O.A.L. — run af17f6bf

## Résumé

- iterations: 1
- last_error: The 'google' packages are required to use GoogleProvider. Install them with: `uv add 'mirascope[google]'`. Or use `uv add 'mirascope[all]'` to support all optional features.
...
### 1 — run_started (2026-07-11T06:02:06.663437+00:00)
...
```json
{
  ...
  "sequence": 1,
  "synthesizer_provider": "google",
  "timestamp_utc": "2026-07-11T06:02:06.663437+00:00",
  "variant": "A"
}
```

### 2 — prompt_saved (2026-07-11T06:02:06.674547+00:00)
...
```json
{
  ...
  "event": "prompt_saved",
  "iteration": 1,
  "path": "/home/eddie/.goal/runs/af17f6bf/prompt_1_producer.txt",
  "role": "producer",
  "run_id": "af17f6bf",
  "sequence": 2,
  "sha256": "b13d801d98aa184251abd12166d114b44a7c5d4896a2b697fedde1c8e0093d7e",
  "timestamp_utc": "2026-07-11T06:02:06.674547+00:00"
}
```

### 3 — provider_call_started (2026-07-11T06:02:06.674761+00:00)
...
```json
{
  ...
  "status": "failed",
  "synthesizer_provider": "google",
  "timestamp_utc": "2026-07-11T06:02:08.091411+00:00",
  "variant": "A",
  "verdict": "absent"
}
```

### 6 — rag_sync_started (2026-07-11T06:02:08.092301+00:00)
...
```json
{
  ...
  "run_id": "af17f6bf",
  "sequence": 6,
  "timeline": "/home/eddie/.goal/runs/af17f6bf/timeline.md",
  "timestamp_utc": "2026-07-11T06:02:08.092301+00:00"
}
```

### 7 — rag_sync_failed (2026-07-11T06:02:08.259019+00:00)
...
```json
{
  ...
  "run_id": "af17f6bf",
  "sequence": 7,
  "timestamp_utc": "2026-07-11T06:02:08.259019+00:00"
}
```

### 8 — error (2026-07-11T06:02:08.468850+00:00)
...
```json
{
  ...
  "run_id": "af17f6bf",
  "sequence": 8,
  "timestamp_utc": "2026-07-11T06:02:08.468850+00:00",
...
Chemin : `/home/eddie/.goal/runs/af17f6bf/prompt_1_producer.txt`
